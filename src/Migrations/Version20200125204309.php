...
final class Version20200125204309 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE transactions (id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', source_transfer_participant_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', target_transfer_participant_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', amount BIGINT UNSIGNED NOT NULL, occurred_at DATETIME NOT NULL, INDEX IDX_EAA81A4C953C1C61 (source_transfer_participant_id), INDEX IDX_EAA81A4C158E0B66 (target_transfer_participant_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE transactions ADD CONSTRAINT FK_EAA81A4C953C1C61 FOREIGN KEY (source_transfer_participant_id) REFERENCES transfer_participants (id)');
        $this->addSql('ALTER TABLE transactions ADD CONSTRAINT FK_EAA81A4C158E0B66 FOREIGN KEY (target_transfer_participant_id) REFERENCES transfer_participants (id)');
